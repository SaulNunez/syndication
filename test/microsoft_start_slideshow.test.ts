...
describe("Microsoft Start Slideshow feed", () => {
    it("Can load namespaced elements", () => {
        ...
        expect(item.extra["mi"]["focalRegion"]["x1"]).to.equal("120");
        expect(item.extra["mi"]["focalRegion"]["y1"]).to.equal("120");
        expect(item.extra["mi"]["focalRegion"]["x2"]).to.equal("400");
        expect(item.extra["mi"]["focalRegion"]["y2"]).to.equal("400");
        expect(item.extra["atom"]["link"]).to.have.deep.members([
            {
                rel: "related",
                type: "text/html",
                ...
                children: {
                    media: {
                        thumbnail: {
                            url: "https://v3spec.msn.com/image2.jpg"
                        }
                    }
                }
            },
            {
                rel: "related",
                type: "text/html",
                href: "https://v3spec.msn.com/news/prop_irs_2.html",
                title: "New IRS proposal",
                children: {
                    media: {
                        thumbnail: {
            ...
            },
            {
                rel: "related",
                type: "text/html",
                href: "https://v3spec.msn.com/news/prop_irs_3.html",
                title: "New IRS proposal",
                children: {
                    media: {
                        thumbnail: {
                            url: "https://v3spec.msn.com/image3.jpg"
                        }
                    }
                }
            }
